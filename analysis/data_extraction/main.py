...
if __name__ == '__main__':
    ...
    for font_format in FontFormat.__members__.values():
        font_paths = [
            URL + ":8080/webserver/fonts/Raleway-ExtraBold." + font_format.name.lower(),
            URL + ":8080/webserver/fonts/Montserrat-SemiBold." + font_format.name.lower(),
            URL + ":8080/webserver/fonts/SourceSans3-Regular." + font_format.name.lower(),
        ]

    # for font_format in FontFormat.__members__.values():
    #     font_paths = [
    #         URL + ":8080/webserver/fonts/Raleway-ExtraBold.subset." + font_format.name.lower(),
    #         URL + ":8080/webserver/fonts/Montserrat-SemiBold.subset." + font_format.name.lower(),
    #         URL + ":8080/webserver/fonts/SourceSans3-Regular.subset." + font_format.name.lower(),
    #     ]

    for test_cases in TestCases.__members__.values():
        files = get_input_files(test_cases.name)
