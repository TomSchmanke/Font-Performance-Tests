...
violin_length <- ggplot(data, aes(x = format, y = data$LENGTH, fill = format, color = format)) +
  ...
  scale_fill_manual(values = c(woff2 = "#DCC7AA", otf = "#6b7a8f", ttf = "#F7882f"), guide = "none") +
  scale_color_manual(values = c(woff2 = "#DCC7AA", otf = "#6b7a8f", ttf = "#F7882f"), guide = "none") +
  theme(legend.position = c(0.88, 0.8)) +
  geom_boxplot(width = 0.2, fill = c("#6b7a8f", "#F7882f", "#DCC7AA"), color = "black", outlier.shape = NA)
...
density_length <- ggplot(data, aes(x = LENGTH)) +
  ...
  scale_fill_manual(values = c(woff2 = "#DCC7AA", otf = "#6b7a8f", ttf = "#F7882f")) +
  scale_color_manual(values = c(woff2 = "#DCC7AA", otf = "#6b7a8f", ttf = "#F7882f")) +
...
violin_length_fonts <- ggplot(data_long, aes(x = Variable, y = LoadTime, fill = format)) +
  ...
  scale_fill_manual(values = c(otf = "#6b7a8f", ttf = "#F7882f", woff2 = "#DCC7AA")) +
  theme_minimal()
